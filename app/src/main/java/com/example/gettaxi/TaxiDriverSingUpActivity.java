...
public class TaxiDriverSingUpActivity extends AppCompatActivity {

    private static final int NAME_LENGTH = 20;
    private static final int PASSWORD_LENGTH = 5;

    private static final String TAG = "TaxiDriverActivity";
    ...
    private TextView singUpAsTaxiDriverTV, tapToSingInTV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTaxiDriverSingUpActivitySetup();
    }
    ...
    private void createTaxiDriverSingUpActivitySetup() {
        singUpAsTaxiDriverTV = findViewById(R.id.sing_up_as_taxi_driver);
    ...
    public void tapToSingIn(View view) {
        if (isSingInActive) {
            ...
            singUpAsTaxiDriverTV.setText(R.string.sing_up_as_taxi_driver);
            ...
            isSingInActive = true;
            singUpAsTaxiDriverTV.setText(R.string.sing_in_as_taxi_driver);
